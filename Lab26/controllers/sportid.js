...
exports.get_biografia = (req, res, next) => {

    const theSportsDB = require("thesportsdb");

    theSportsDB.setApiKey("3");

    theSportsDB.getPlayerByName("Lebron James", "Los Angeles Lakers")
...
exports.get_playersnba = (req, res, next) => {
    ...
    // theSportsDB.getLeagueList().then((data) => {
    //     console.log(data);
    // });

    // theSportsDB.getPlayerFormerTeamsById().then((data) => {
    //     console.log(data);
    // });
